...
public class ShangjiaController {
    ...
    public R info(@PathVariable("id") Long id){
		...
		shangjia.setClicknum(shangjia.getClicknum()+1);
		shangjia.setClicktime(new Date());
    ...
    public R autoSort(@RequestParam Map<String, Object> params,ShangjiaEntity shangjia, HttpServletRequest request,String pre){
        EntityWrapper<ShangjiaEntity> ew = new EntityWrapper<ShangjiaEntity>();
