      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="店铺名" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.dianpuming" autocomplete="off" placeholder="店铺名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			...
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.jianzhumianji" class="input" type="text" placeholder="建筑面积">
			   </div>
			 </div> -->
			<el-form-item label="建筑面积" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.jianzhumianji" autocomplete="off" placeholder="建筑面积"  />
			</el-form-item>
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
