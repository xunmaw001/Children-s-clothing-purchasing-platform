<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="建筑面积" prop="jianzhumianji">
          <el-input v-model="ruleForm.jianzhumianji" 
              placeholder="建筑面积" clearable  :readonly="ro.jianzhumianji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="建筑面积" prop="jianzhumianji">
              <el-input v-model="ruleForm.jianzhumianji" 
                placeholder="建筑面积" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.jingyingfanwei" label="经营范围" prop="jingyingfanwei">
                    <span>{{ruleForm.jingyingfanwei}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
